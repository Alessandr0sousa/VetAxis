...
import { Page, TipoAgendamento } from '@core/models';
import { ConsultasFormAgendamentosModel } from 'src/app/components/models/consultas-form-agendametos-model';
import { AgendamentosAgrupados } from 'src/app/components/models/agendamentos-model';
  ...
  salvarCirurgia(cirurgia: ConsultasFormAgendamentosModel): Observable<ConsultasFormAgendamentosModel> {
    try {
      ...
      const tipoPayload = {
        ...
        anestesista: (cirurgia as any)?.cirurgia?.anestesista ?? '',
